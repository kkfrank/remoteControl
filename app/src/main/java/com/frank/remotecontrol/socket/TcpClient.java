...
public abstract class TcpClient implements Runnable {
		...
		try {
			...
			transceiver = new SocketTransceiver(socket) {
				...
				public void sendFailed(String error) {
					TcpClient.this.sendFailed(error);
				}
			};
			transceiver.start();
			connect = true;
			...
			e.printStackTrace();
			this.onConnectFailed(e.getMessage());
		}
	}
	 ...
	 * 连接建立失败
	 */
	public abstract void onConnectFailed(String error);
	...
	public abstract void sendFailed(String error);
}
